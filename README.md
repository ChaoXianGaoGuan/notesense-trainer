...
- 切分节奏跟拍：看简谱式或五线谱式四小节节奏型，在 2/4、3/4、4/4 中练习四分、二八、四十六、附点、小切分、三连音、大切分和延音线。延音线训练每题包含跨拍与跨小节持续音，续音不要求再次拍击；跨显示行时使用出弧和入弧两段表示。每题保证出现当前难度重点素材，并可混入更早难度素材；可选择节拍器全程播放或仅播放预备拍，默认全程播放；普通手机视口分行显示，浏览器电脑模式下四小节保持同一行。
...
切分节奏的简谱显示也有独立核心逻辑：`src/core/jianpu-rhythm.ts` 负责把节奏格转换成教学型简谱 layout，包括小节、拍点、符号位置、减时线、附点、三连音弧线与中央数字 `3`、跨拍延音线和反馈高亮。React 只渲染 layout 结果。
